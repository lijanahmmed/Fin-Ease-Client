...
const Banner = () => {
  return (
    <div className="w-11/12 md:w-10/12 mx-auto mt-15 flex items-center flex-col-reverse md:flex-row">
      <div className="flex-1/2">
        <h1 className="text-5xl md:text-6xl">Grow Your <span className="text-purple-600">Wealth</span></h1>
      ...
      <div className="flex-1/2 md:ml-30">
        <img className="w-96"
