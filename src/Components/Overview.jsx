  ...
  return (
    <div className="mt-20 w-11/12 md:10/12 mx-auto">
      ...
      <div className="mt-10 flex flex-col md:flex-row gap-10 w-full">
        ...
        <div className="text-white text-center bg-gradient-to-r from-green-500 to-green-400 py-20 rounded-2xl flex-1">
        ...
        <div className="text-white text-center bg-gradient-to-r from-blue-500 to-blue-400 py-20 rounded-2xl flex-1">
